      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-6 md:justify-start md:space-x-10">
          ...
          >
            <div
              onClick={() => toggleTheme()}
              className="cursor-pointer bg-primary shadow-2xl shadow-primary text-2xl text-white hover:text-white hover:dark:text-white  w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-200"
            >
              {isTheme === "dark" ? (
              ...
              >
                <Link href={page.href} key={page.name}>
                  <button
                    ...
                    } hover:text-gray-900 dark:hover:text-gray-100 font-semibold button-text cursor-pointer`}
                  >
                    {router.pathname === page.href ? (
                      <span className="border-b-2 border-black dark:border-white padding cursor-pointer">
                        {" "}
                        <i
                          className={`${page.icon.active} text-gray-900 dark:text-gray-100`}
                        />{" "}
                        {page.name}
                      </span>
                    ) : (
                      <span className="cursor-pointer">
                        {" "}
                        <i
                          className={`${page.icon.default} text-black dark:text-white padding-2 cursor-pointer`}
                        />{" "}
                        {page.name}
                      </span>
                    )}
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="cursor-pointer whitespace-nowrap  text-base font-semibold text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-gray-100 button-text "
              >
              ...
              >
                <div className="flex items-center gap-4">
                  <a
                    ...
                    className="bg-primary shadow-2xl shadow-primary text-2xl text-white hover:text-white hover:dark:text-white cursor-pointer w-12 h-12 flex items-center justify-center rounded-lg transition-all duration-200 "
                  >
                    <i className="fa-brands cursor-pointer fa-twitter" />
                  </a>
                </div>
              </motion.div>
            </div>
